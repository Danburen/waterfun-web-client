<template>
  <div class="content">
    <canvas class="snow" id="snow" ref="snowCanvas"></canvas>
    <div class="main-text">
      <h1>Aw jeez.<br />That page has gone missing.</h1>
      <router-link class="home-link" to="/">Hitch a ride back home.</router-link>
    </div>
    <div class="ground">
      <div class="mound">
...
function updateParticles(ctx, width, height) {
  ...
  animationFrameId = requestAnimationFrame(() => updateParticles(ctx, width, height))
}
...
function handleResize(canvas) {
  ...
  createParticles((width * height) / 10000, width, height)
}
